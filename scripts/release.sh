#!/usr/bin/env bash
#
# scripts/release.sh: opinionated release preparation wrapper for Egide.
#
# Usage:
...
new_links = (
    "[Unreleased]: https://github.com/nubster-opensources/egide/compare/v"
    + new_version
    + "...HEAD\n["
    + new_version
    + "]: https://github.com/nubster-opensources/egide/releases/tag/v"
    + new_version
)
